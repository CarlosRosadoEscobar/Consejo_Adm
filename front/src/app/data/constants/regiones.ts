...
console.log(estados[0]); // Imprime el primer estado
console.log(estados[0].region); // Imprime el nombre de la primera región
console.log(estados[0].abreviatura); // Imprime la abreviatura del primer estado
